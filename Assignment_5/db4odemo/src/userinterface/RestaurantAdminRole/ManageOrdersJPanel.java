    ...
    public void populateTable() {
        ...
        for (Order order : ecoSystem.getOrderDirectory().getOrderList()) {
          //  System.out.println(" Rest  " + userAccount.getEmployee().getName() + "  " + order.getOrderRestaurant().getRestaurantName());
            if (userAccount.getEmployee().getName().equals(order.getOrderRestaurant().getRestaurantName())) {
                Object[] r = new Object[5];
                r[0] = order;
                r[1] = order.getMenu().getFoodName();
                r[2] = order.getItemQuantity();
                r[3] = order.getItemQuantity() * order.getMenu().getFoodItemPrice();

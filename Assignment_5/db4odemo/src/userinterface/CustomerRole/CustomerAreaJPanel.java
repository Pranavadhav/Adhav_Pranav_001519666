...
public class CustomerAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        requestTestJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button_add-comment (1).png"))); // NOI18N
        requestTestJButton.setBorderPainted(false);
        requestTestJButton.setContentAreaFilled(false);
        ...
        refreshTestJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button_refresh (2).png"))); // NOI18N
        refreshTestJButton.setBorderPainted(false);
        refreshTestJButton.setContentAreaFilled(false);
        ...
        valueLabel.setForeground(new java.awt.Color(0, 181, 204));
        ...
        btnMenuShow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button_view-menu (1).png"))); // NOI18N
        ...
        add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button_add-item.png"))); // NOI18N
        ...
        confirm.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/button_confirm-order (1).png"))); // NOI18N
